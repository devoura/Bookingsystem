...
print("Den totale prisen for ditt opphold blir KR $totalPris <br />");
...
<form action="" method="post" input="text" id="tekstfelt" name="tekstfelt" >
	...
	<a href='avbryt.php'><input type='submit' name='avbryt' id='avbryt' value='Avbryt bestilling'/></a>
...
$sqlSetning="INSERT INTO bestilling (BestillingID, HotellID, KundeID, BetalingsID, RomtypeID, Pris, DatoAnkomst, DatoAvreise, Frokost, Tilstand) SELECT NULL AS BestillingID, '$hotellID' AS HotellID, kundeinfo.KundeID, betalingsinfo.BetalingsID, '$ID' AS RomtypeID, '$totalRomPris' AS Pris, '$innsjekkDato' AS DatoAnkomst, '$utsjekkDato', '$frokost' AS Frokost, NULL AS Tilstand  
