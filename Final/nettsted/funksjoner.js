...
function validateEndreBestilling()
{
    var x = document.forms["tekstfelt"]["kundeID"].value;
    if(x == null || x==""){
    document.forms["tekstfelt"]["kundeID"].style.backgroundColor ="red";
    document.getElementById("melding").innerHTML="Kunde-ID må fylles ut";
    return false;
    }
}
