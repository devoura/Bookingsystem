...
<form method="post" action="" id="tekstfelt" name="registrerRomtype" onSubmit="return validateRegistrerRomType();">
	<input type="text" id="romtype" name="romtype" placeholder="Romtype" maxlength="45" onClick="whitefield();" /><i>Enkeltrom, suite o.l </i><br/>
	<input type="text" id="romtypeID" name="romtypeID" placeholder="RomtypeID" maxlength="2" /><i>2 Bokstaver</i><br/>
	<input type="number" id="prisPerDogn" name="prisPerDogn"  placeholder="Pris per døgn" /> <br/>
