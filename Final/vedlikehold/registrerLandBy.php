...
<hr>
<h3>Hotell</h3>
<form action="" method="post" input="text" id="tekstfelt" name="tekstfelt" onSubmit="return validateHotell();" >
		<?php include("listeboksBy.php"); ?>
		<input type="text" id="hotellID" name="hotellID" placeholder="Hotellets ID"  /><i>3 bokstaver etterfulgt av 2 siffer.</i><br/>
