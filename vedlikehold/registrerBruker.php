...
<form action="" method="post" input="text" id="tekstfelt" name="tekstfelt" onSubmit="return validateNAVNAVNAN()">
	...
	$lovligfelt=false;
		...
		$antallRader=mysqli_num_rows($sqlResultat);
			...
			if($lovligbrukernavn && $lovligfelt)
				{
				$sqlSetning="INSERT INTO admin VALUES ('$brukernavn', '$passord');";
